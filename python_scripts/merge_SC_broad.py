...
folder_path = '/trinity/home/dmartinovicova/all_data/Neftel_broadSC/output'
...
merged_adata.obs_names = merged_adata.obs_names + '_Neftel-broadSC'

print(merged_adata.var_names, merged_adata.obs_names)

#create output file
output_file = os.path.join(folder_path, 'merged/merged_samples_Neftel_SC_broad.h5ad') #output directory
